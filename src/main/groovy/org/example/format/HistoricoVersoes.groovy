...
class HistoricoVersoes {
    ...
    HistoricoVersoes(String competencia, String publicacao, String inicioDeVigencia, String limiteDeImplantacao, String organizacional, String conteudoEstrutura, String representacaoConceitos, String segurancaPrivacida, List<String> comunicacao) {
