...
import org.example.format.HistoricoVersoes
...
class TabelaHistoricoVersoes {

    AcessarSite acess = new AcessarSite()
    ...
    List instanciaListaHistoricoVersoes(){
        ...
        ArrayList<TabelaHistoricoVersoes> listaVersoes = new ArrayList<TabelaHistoricoVersoes>()
